...
import com.autoai.themestore.activity.FullScreenPreviewActivity;
...
import static com.autoai.themestore.R.id.theme_collection_checkbox;
...
public class ThemeDetailFragment extends BaseFragment {
    ...
    public void initView(View rootView) {
        ...
        //初始化指示点布局,
        tipPointGroup.init(mAutoViewPagerAdapter.getRealCount(), R.drawable.selector_theme_detail_position_point, 80, 10);
